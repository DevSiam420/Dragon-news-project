import { C as LogLevel, D as FirebaseError, L as isCloudWorkstation, P as getModularInstance, w as Logger } from "./index.esm-q5xya5K-.js";
import { t as Integer } from "./bloom_blob_es2018-FJXBemNj.js";

//#region node_modules/@firebase/firestore/dist/lite/common-a3b291a4.esm.js
/**
* @license
...
/** The default database name for a project. */ var P = "(default)";
/**
...
*/ function __PRIVATE_randomBytes(e) {
	const t = "undefined" != typeof self && (self.crypto || self.msCrypto), r = new Uint8Array(e);
	if (t && "function" == typeof t.getRandomValues) t.getRandomValues(r);
	else for (let t = 0; t < e; t++) r[t] = Math.floor(256 * Math.random());
	return r;
}
/**
* @license
...
*/ var __PRIVATE_AutoId = class {
	static newId() {
		...
		for (; r.length < 20;) {
			...
			for (let i = 0; i < n.length; ++i) r.length < 20 && n[i] < t && (r += e.charAt(n[i] % 62));
		}
		return r;
	}
};
	...
	*/ static fromServerFormat(e) {
		...
		for (; n < e.length;) {
			...
			if ("\\" === t) {
				...
				r += t, n += 2;
			} else "`" === t ? (i = !i, n++) : "." !== t || i ? (r += t, n++) : (__PRIVATE_addCurrentSegment(), n++);
		}
...
var __PRIVATE_RestConnection = class {
	...
	I(e, r, n, i, s) {
		...
		return this.v(e, a, u, n, c).then(((t) => (__PRIVATE_logDebug(p, `Received RPC '${e}' ${o}: `, t), t)), ((t) => {
			throw __PRIVATE_logWarn(p, `RPC '${e}' ${o} failed with error: `, t, "url: ", a, "request:", n), t;
		}));
	}
	D(e, t, r, n, i, s) {
	...
	*/ F(e, t, r) {
		e["X-Goog-Api-Client"] = function __PRIVATE_getGoogApiClientValue() {
			return "gl-js/ fire/" + d;
		}(), e["Content-Type"] = "text/plain", this.databaseInfo.appId && (e["X-Firebase-GMPID"] = this.databaseInfo.appId), t && t.headers.forEach(((t, r) => e[r] = t)), r && r.headers.forEach(((t, r) => e[r] = t));
	}
	p(e, t) {
		const r = y[e];
		let n = `${this.R}/v1/${t}:${r}`;
...
*/ function __PRIVATE_mapCodeFromHttpStatus(e) {
	...
	switch (e) {
		case 200: return E.OK;
		case 400: return E.FAILED_PRECONDITION;
		...
		default: return e >= 200 && e < 300 ? E.OK : e >= 400 && e < 500 ? E.FAILED_PRECONDITION : e >= 500 && e < 600 ? E.INTERNAL : E.UNKNOWN;
	}
}
/**
* @license
...
*/ (g = w || (w = {}))[g.OK = 0] = "OK", g[g.CANCELLED = 1] = "CANCELLED", g[g.UNKNOWN = 2] = "UNKNOWN", g[g.INVALID_ARGUMENT = 3] = "INVALID_ARGUMENT", g[g.DEADLINE_EXCEEDED = 4] = "DEADLINE_EXCEEDED", g[g.NOT_FOUND = 5] = "NOT_FOUND", g[g.ALREADY_EXISTS = 6] = "ALREADY_EXISTS", g[g.PERMISSION_DENIED = 7] = "PERMISSION_DENIED", g[g.UNAUTHENTICATED = 16] = "UNAUTHENTICATED", g[g.RESOURCE_EXHAUSTED = 8] = "RESOURCE_EXHAUSTED", g[g.FAILED_PRECONDITION = 9] = "FAILED_PRECONDITION", g[g.ABORTED = 10] = "ABORTED", g[g.OUT_OF_RANGE = 11] = "OUT_OF_RANGE", g[g.UNIMPLEMENTED = 12] = "UNIMPLEMENTED", g[g.INTERNAL = 13] = "INTERNAL", g[g.UNAVAILABLE = 14] = "UNAVAILABLE", g[g.DATA_LOSS = 15] = "DATA_LOSS";
...
var F = /* @__PURE__ */ new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
/**
...
*/ function __PRIVATE_normalizeTimestamp(e) {
	if (__PRIVATE_hardAssert(!!e, 39018), "string" == typeof e) {
		let t = 0;
		const r = F.exec(e);
		if (__PRIVATE_hardAssert(!!r, 46558, { timestamp: e }), r[1]) {
			let e = r[1];
...
*/ function __PRIVATE_validateJSON(e, t) {
	...
	for (const n in t) if (t[n]) {
		const i = t[n].typeString, s = "value" in t[n] ? { value: t[n].value } : void 0;
		if (!(n in e)) {
...
var Timestamp = class Timestamp {
	...
	*/ static fromMillis(e) {
		...
		return new Timestamp(t, Math.floor((e - 1e3 * t) * b));
	}
	/**
...
function __PRIVATE_isServerTimestamp(e) {
	return "server_timestamp" === (e?.mapValue?.fields || {}).__type__?.stringValue;
}
/**
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var D = "__type__", S = "__max__", C = { fields: { __type__: { stringValue: S } } }, N = "__vector__", O = "value";
/** Extracts the backend's type order for the provided value. */
function __PRIVATE_typeOrder(e) {
	return "nullValue" in e ? 0 : "booleanValue" in e ? 1 : "integerValue" in e || "doubleValue" in e ? 2 : "timestampValue" in e ? 3 : "stringValue" in e ? 5 : "bytesValue" in e ? 6 : "referenceValue" in e ? 7 : "geoPointValue" in e ? 8 : "arrayValue" in e ? 9 : "mapValue" in e ? __PRIVATE_isServerTimestamp(e) ? 4 : function __PRIVATE_isMaxValue(e) {
		return (((e.mapValue || {}).fields || {}).__type__ || {}).stringValue === S;
	}(e) ? 9007199254740991 : function __PRIVATE_isVectorValue(e) {
		return (e?.mapValue?.fields || {})[D]?.stringValue === N;
	}(e) ? 10 : 11 : fail(28295, { value: e });
}
...
function __PRIVATE_valueCompare(e, t) {
	...
	switch (r) {
		...
		case 2: return function __PRIVATE_compareNumbers(e, t) {
			...
			return r < n ? -1 : r > n ? 1 : r === n ? 0 : isNaN(r) ? isNaN(n) ? 0 : -1 : 1;
		}(e, t);
...
function __PRIVATE_deepClone(e) {
	...
	if (e.mapValue) {
		...
		return forEach(e.mapValue.fields, ((e, r) => t.mapValue.fields[e] = __PRIVATE_deepClone(r))), t;
	}
	if (e.arrayValue) {
...
var SortedMapIterator = class {
	constructor(e, t, r, n) {
		...
		let i = 1;
		for (; !e.isEmpty();) if (i = t ? r(e.key, t) : 1, t && n && (i *= -1), i < 0) e = this.isReverse ? e.left : e.right;
		else {
			if (0 === i) {
...
var LLRBNode = class LLRBNode {
	constructor(e, t, r, n, i) {
		this.key = e, this.value = t, this.color = null != r ? r : LLRBNode.RED, this.left = null != n ? n : LLRBNode.EMPTY, this.right = null != i ? i : LLRBNode.EMPTY, this.size = this.left.size + 1 + this.right.size;
	}
	copy(e, t, r, n, i) {
...
var SortedSet = class SortedSet {
	...
	*/ forEachWhile(e, t) {
		let r;
		for (r = void 0 !== t ? this.data.getIteratorFrom(t) : this.data.getIterator(); r.hasNext();) if (!e(r.getNext().key)) return;
	}
...
*/ var ObjectValue = class ObjectValue {
	...
	*/ getFieldsMap(e) {
		...
		for (let r = 0; r < e.length; ++r) {
			...
			__PRIVATE_isMapValue(n) && n.mapValue.fields || (n = { mapValue: { fields: {} } }, t.mapValue.fields[e.get(r)] = n), t = n;
		}
...
var __PRIVATE_QueryImpl = class {
	...
	*/
	constructor(e, t = null, r = [], n = [], i = null, s = "F", o = null, a = null) {
		this.path = e, this.collectionGroup = t, this.explicitOrderBy = r, this.filters = n, this.limit = i, this.limitType = s, this.startAt = o, this.endAt = a, this.q = null, this.L = null, this.B = null, this.startAt, this.endAt;
	}
};
...
function __PRIVATE_fromPipelineResponse(e, t, r) {
	...
	return n.executionTime = t.executionTime ? __PRIVATE_fromVersion(t.executionTime) : void 0, r && (n.key = r.name ? fromName(e, r.name) : void 0, n.fields = new ObjectValue({ mapValue: { fields: r.fields } }), n.createTime = r.createTime ? __PRIVATE_fromVersion(r.createTime) : void 0, n.updateTime = r.updateTime ? __PRIVATE_fromVersion(r.updateTime) : void 0), n;
}
...
*/ var __PRIVATE_DatastoreImpl = class extends Datastore {
	constructor(e, t, r, n) {
		super(), this.authCredentials = e, this.appCheckCredentials = t, this.connection = r, this.serializer = n, this.k = !1;
	}
	j() {
...
async function __PRIVATE_invokeExecutePipeline(e, t) {
	const r = __PRIVATE_debugCast(e), n = {
		database: (i = r.serializer, new ResourcePath([
			"projects",
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var $ = "ComponentProvider", Q = /* @__PURE__ */ new Map();
/**
...
*/ var U = 1048576, M = "firestore.googleapis.com", x = !0;
/**
...
var Firestore = class {
	/** @hideconstructor */
	constructor(e, t, r, n) {
		this._authCredentials = e, this._appCheckCredentials = t, this._databaseId = r, this._app = n, this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new FirestoreSettingsImpl({}), this._settingsFrozen = !1, this._emulatorOptions = {}, this._terminateTask = "notTerminated";
	}
	/**
	...
	_setSettings(e) {
		...
		this._settings = new FirestoreSettingsImpl(e), this._emulatorOptions = e.emulatorOptions || {}, void 0 !== e.credentials && (this._authCredentials = function __PRIVATE_makeAuthCredentialsProvider(e) {
			...
			switch (e.type) {
				...
				default: throw new FirestoreError(E.INVALID_ARGUMENT, "makeAuthCredentialsProvider failed due to invalid credential type");
			}
		}(e.credentials));
	}
	_getSettings() {
...
var CollectionReference = class CollectionReference extends Query {
	...
	constructor(e, t, r) {
		...
		}(r)), this._path = r, this.type = "collection";
	}
...
function doc(e, t, ...r) {
	if (e = getModularInstance(e), 1 === arguments.length && (t = __PRIVATE_AutoId.newId()), __PRIVATE_validateNonEmptyArgument("doc", "path", t), e instanceof Firestore) {
		const n = ResourcePath.fromString(t, ...r);
		return __PRIVATE_validateDocumentPath(n), new DocumentReference(e, null, new DocumentKey(n));
	}
	{
...
/** A "context" object passed around while parsing user data. */ var ParseContextImpl = class ParseContextImpl {
	...
	*/
	constructor(e, t, r, n, i, s) {
		this.settings = e, this.databaseId = t, this.serializer = r, this.ignoreUndefinedProperties = n, void 0 === i && this.validatePath(), this.fieldTransforms = i || [], this.fieldMask = s || [];
	}
	get path() {
	...
	if (t.path && t.fieldMask.push(t.path), e instanceof Array) {
		...
		return function __PRIVATE_parseArray(e, t) {
			...
			for (const i of e) {
				...
				e ??= { nullValue: "NULL_VALUE" }, r.push(e), n++;
			}
 ...
 /**
		...
		*/
		return function __PRIVATE_parseVectorValue(e, t) {
			const r = e instanceof VectorValue ? e.toArray() : e;
			return { mapValue: { fields: {
				[D]: { stringValue: N },
				[O]: { arrayValue: { values: r.map(((e) => {
...
function __PRIVATE_parseObject(e, t) {
	...
	return !function isEmpty(e) {
		...
		null != i && (r[e] = i);
	})) : t.path && t.path.length > 0 && t.fieldMask.push(t.path), { mapValue: { fields: r } };
}
...
*/ function __PRIVATE_fieldPathFromArgument(e, t, r) {
	...
	throw createError("Field path arguments must be of type string or ", e, !1, void 0, r);
}
/**
* Matches any characters in a field path string that are reserved.
*/ var j = /* @__PURE__ */ new RegExp("[~\\*/\\[\\]]");
/**
...
*/ function __PRIVATE_fieldPathFromDotSeparatedString(e, t, r) {
	if (t.search(j) >= 0) throw createError(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`, e, !1, void 0, r);
	try {
		return new FieldPath(...t.split("."))._internalPath;
	} catch (n) {
		throw createError(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, e, !1, void 0, r);
	}
}
...
var AbstractUserDataWriter = class {
	...
	*/ convertVectorValue(e) {
	...
	convertDocumentKey(e, t) {
		...
		__PRIVATE_hardAssert(__PRIVATE_isValidResourceName(r), 9688, { name: e });
		const n = new DatabaseId(r.get(1), r.get(3)), i = new DocumentKey(r.popFirst(5));
		return n.isEqual(t) || __PRIVATE_logError(`Document ${i} contains a document reference within a different database (${n.projectId}/${n.database}) which is not supported. It will be treated as a reference in the current database (${t.projectId}/${t.database}) instead.`), i;
	}
};
...
//#endregion
//#region node_modules/@firebase/firestore/dist/lite/pipelines.browser.esm.js
/**
* @license
* Copyright 2025 Google LLC
*
	...
	_getKnownOptions(s, i) {
		...
		for (const e in this.optionDefinitions) if (this.optionDefinitions.hasOwnProperty(e)) {
			...
			if (e in s) {
				const u = s[e];
				let _;
				if (a.nestedOptions && __PRIVATE_isPlainObject(u)) _ = { mapValue: { fields: new OptionsUtil(a.nestedOptions).getOptionsProto(i, u) } };
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var __PRIVATE_StructuredPipelineOptions = class {
	constructor(e = {}, t = {}) {
		this.t = e, this.i = t, this.o = new OptionsUtil({ indexMode: { serverName: "index_mode" } });
	}
	_readUserData(e) {
		this.proto = this.o.getOptionsProto(e, this.t, this.i);
	}
};
var StructuredPipeline = class {
	constructor(e, t) {
...
*/ function __PRIVATE_fieldOrExpression$1(e) {
	if (__PRIVATE_isString(e)) return field(e);
...
*/ var Expression = class {
	...
	*/ stringReplaceAll(e, t) {
		return new FunctionExpression("string_replace_all", [
			this,
			__PRIVATE_valueToDefaultExpr$1(e),
			__PRIVATE_valueToDefaultExpr$1(t)
		], "stringReplaceAll");
	}
	/**
	* @beta
	...
	*/ mapSet(e, t, ...n) {
		return new FunctionExpression("map_set", [
			this,
			__PRIVATE_valueToDefaultExpr$1(e),
			__PRIVATE_valueToDefaultExpr$1(t),
			...n.map(__PRIVATE_valueToDefaultExpr$1)
		], "mapSet");
	}
	/**
	* @beta
	...
	*/ documentId() {
	...
	substring(e, t) {
		...
		return new FunctionExpression("substring", void 0 === t ? [this, n] : [
			this,
			n,
			__PRIVATE_valueToDefaultExpr$1(t)
		], "substring");
...
*/ var AggregateFunction = class AggregateFunction {
	constructor(e, t) {
...
*/ var __PRIVATE_ListOfExprs = class extends Expression {
	...
	* @internal
	*/ _toProto(e) {
		return { arrayValue: { values: this.u.map(((t) => t._toProto(e))) } };
	}
	/**
	* @private
	* @internal
...
* ```
*/ var Constant = class Constant extends Expression {
	/**
	* @private
	* @internal
	* @hideconstructor
	...
	* @internal
	*/ _readUserData(e) {
		e = this._methodName ? e.contextWith({ methodName: this._methodName }) : e, __PRIVATE_isFirestoreValue(this._protoValue) || (this._protoValue = __PRIVATE_parseData(this.value, e));
	}
};
function constant(e) {
...
*/ var MapValue = class extends Expression {
	...
	_readUserData(e) {
		e = this._methodName ? e.contextWith({ methodName: this._methodName }) : e, this._.forEach(((t) => {
			t._readUserData(e);
		}));
	}
	_toProto(e) {
...
*/ var BooleanExpression = class BooleanExpression extends Expression {
	get _methodName() {
...
*/ function and(e, t, ...n) {
	return new FunctionExpression("and", [
		e,
		t,
		...n
	], "and").asBoolean();
...
*/ function or(e, t, ...n) {
	return new FunctionExpression("or", [
		e,
		t,
		...n
	], "xor").asBoolean();
...
function concat(e, t, ...n) {
	return new FunctionExpression("concat", [
		__PRIVATE_fieldOrExpression$1(e),
		__PRIVATE_valueToDefaultExpr$1(t),
		...n.map(__PRIVATE_valueToDefaultExpr$1)
	]);
}
...
function __PRIVATE_toPipelineBooleanExpr(e) {
	if (e instanceof FieldFilter) {
		...
		switch (e.op) {
			case "<": return and(t.exists(), t.lessThan(Constant._fromProto(n)));
			case "<=": return and(t.exists(), t.lessThanOrEqual(Constant._fromProto(n)));
			case ">": return and(t.exists(), t.greaterThan(Constant._fromProto(n)));
			case ">=": return and(t.exists(), t.greaterThanOrEqual(Constant._fromProto(n)));
			case "==": return and(t.exists(), t.equal(Constant._fromProto(n)));
			case "!=": return t.notEqual(Constant._fromProto(n));
			case "array-contains": return and(t.exists(), t.arrayContains(Constant._fromProto(n)));
			case "in": {
...
function __PRIVATE_toPipeline(e, t) {
	...
	const i = r.map(((e) => "asc" === e.dir ? field(e.field.canonicalString()).ascending() : field(e.field.canonicalString()).descending()));
	if (i.length > 0) if ("L" === e.limitType) {
		...
		n = n.sort(t[0], ...t.slice(1)), null !== e.startAt && (n = n.where(__PRIVATE_whereConditionsFromCursor(e.startAt, i, "after"))), null !== e.endAt && (n = n.where(__PRIVATE_whereConditionsFromCursor(e.endAt, i, "before"))), n = n.limit(e.limit), n = n.sort(i[0], ...i.slice(1));
	} else n = n.sort(i[0], ...i.slice(1)), null !== e.startAt && (n = n.where(__PRIVATE_whereConditionsFromCursor(e.startAt, i, "after"))), null !== e.endAt && (n = n.where(__PRIVATE_whereConditionsFromCursor(e.endAt, i, "before"))), null !== e.limit && (n = n.limit(e.limit));
	return n;
}
function __PRIVATE_whereConditionsFromCursor(e, t, n) {
	...
	e.inclusive && (u = or(u, o.equal(a)));
	for (let e = i - 2; e >= 0; e--) o = t[e].expr, a = s[e], u = or(r(o, a), and(o.equal(a), u));
	return u;
}
/**
* @license
...
*/ var __PRIVATE_CollectionSource = class extends Stage {
	...
	constructor(e, t) {
		super(t), this.l = e.startsWith("/") ? e : "/" + e;
	}
	/**
	* @internal
	* @private
...
*/ var __PRIVATE_DocumentsSource = class extends Stage {
	...
	*/ _toProto(e) {
		return {
			...super._toProto(e),
			args: this.p.map(((e) => ({ referenceValue: e })))
		};
	}
	_readUserData(e) {
		super._readUserData(e);
...
*/ var __PRIVATE_FindNearest = class extends Stage {
	...
	get _optionsUtil() {
		return new OptionsUtil({
			limit: { serverName: "limit" },
			distanceField: { serverName: "distance_field" }
		});
	}
	constructor(e, t, n, r) {
	...
	*/ _toProto(e) {
		return {
			...super._toProto(e),
			args: [
				this.field._toProto(e),
				this.vectorValue._toProto(e),
				__PRIVATE_toStringValue(this.distanceMeasure)
			]
		};
	}
	_readUserData(e) {
...
*/ var __PRIVATE_Unnest = class extends Stage {
	...
	get _optionsUtil() {
		return new OptionsUtil({ indexField: { serverName: "index_field" } });
	}
	constructor(e, t, n) {
...
/**
* @beta
*/ var __PRIVATE_Replace = class __PRIVATE_Replace extends Stage {
	get _name() {
		return "replace_with";
	}
	get _optionsUtil() {
...
var __PRIVATE_RawStage = class extends Stage {
	...
	*/
	constructor(e, t, n) {
		super({ rawOptions: n }), this.name = e, this.params = t;
	}
	/**
	* @internal
	* @private
...
*/ function __PRIVATE_readUserDataHelper(e, t) {
	return __PRIVATE_isUserData(e) ? e._readUserData(t) : Array.isArray(e) ? e.forEach(((e) => e._readUserData(t))) : e.forEach(((e) => e._readUserData(t))), e;
}
/**
* @license
* Copyright 2024 Google LLC
...
*/ var PipelineSource = class {
	...
	*/
	...
	collection(e) {
		...
		const s = new __PRIVATE_CollectionSource(__PRIVATE_isString(n) ? n : n.path, t), i = this.userDataReader.createContext(3, "collection");
		return s._readUserData(i), this._createPipeline([s]);
	}
	collectionGroup(e) {
		let t, n;
		__PRIVATE_isString(e) ? (t = e, n = {}) : {collectionId: t, ...n} = e;
		const r = new __PRIVATE_CollectionGroupSource(t, n), s = this.userDataReader.createContext(3, "collectionGroup");
		return r._readUserData(s), this._createPipeline([r]);
	}
	database(e) {
		const t = new __PRIVATE_DatabaseSource(e = e ?? {}), n = this.userDataReader.createContext(3, "database");
		return t._readUserData(n), this._createPipeline([t]);
	}
	documents(e) {
		let t, n;
		Array.isArray(e) ? (n = e, t = {}) : {docs: n, ...t} = e, n.filter(((e) => e instanceof DocumentReference)).forEach(((e) => this._validateReference(e)));
		const s = new __PRIVATE_DocumentsSource(n.map(((e) => __PRIVATE_isString(e) ? e : e.path)), t), i = this.userDataReader.createContext(3, "documents");
		return s._readUserData(i), this._createPipeline([s]);
	}
	/**
	* @beta
...
*/ var PipelineResult = class {
	...
	*/
	constructor(e, t, n, r, s) {
		this._ref = n, this._userDataWriter = e, this._createTime = r, this._updateTime = s, this._fields = t;
	}
	/**
	* @beta
...
*/ function __PRIVATE_selectablesToMap(e) {
	...
	for (const n of e) {
		let e, r;
		if ("string" == typeof n ? (e = n, r = field(n)) : n instanceof Field || n instanceof AliasedExpression ? (e = n.alias, r = n.expr) : fail(21273, { selectable: n }), void 0 !== t.get(e)) throw new FirestoreError("invalid-argument", `Duplicate alias or field '${e}'`);
		t.set(e, r);
	}
	return t;
}
...
var Pipeline = class Pipeline {
	...
	*/
	...
	addFields(e, ...t) {
		...
		const i = new __PRIVATE_AddFields(__PRIVATE_selectablesToMap(n), r), o = this.userDataReader.createContext(3, "addFields");
		return i._readUserData(o), this._addStage(i);
	}
	removeFields(e, ...t) {
		const n = __PRIVATE_isField(e) || __PRIVATE_isString(e) ? {} : e, s = new __PRIVATE_RemoveFields((__PRIVATE_isField(e) || __PRIVATE_isString(e) ? [e, ...t] : e.fields).map(((e) => __PRIVATE_isString(e) ? field(e) : e)), n);
		return s._readUserData(this.userDataReader.createContext(3, "removeFields")), this._addStage(s);
	}
	select(e, ...t) {
		const n = __PRIVATE_isSelectable(e) || __PRIVATE_isString(e) ? {} : e, s = new __PRIVATE_Select(__PRIVATE_selectablesToMap(__PRIVATE_isSelectable(e) || __PRIVATE_isString(e) ? [e, ...t] : e.selections), n), i = this.userDataReader.createContext(3, "select");
		return s._readUserData(i), this._addStage(s);
	}
	where(e) {
		const t = __PRIVATE_isBooleanExpr(e) ? {} : e, r = new __PRIVATE_Where(__PRIVATE_isBooleanExpr(e) ? e : e.condition, t), s = this.userDataReader.createContext(3, "where");
		return r._readUserData(s), this._addStage(r);
	}
	offset(e) {
		let t, n;
		__PRIVATE_isNumber(e) ? (t = {}, n = e) : (t = e, n = e.offset);
		const r = new __PRIVATE_Offset(n, t), s = this.userDataReader.createContext(3, "offset");
		return r._readUserData(s), this._addStage(r);
	}
	limit(e) {
		const t = __PRIVATE_isNumber(e) ? {} : e, r = new __PRIVATE_Limit(__PRIVATE_isNumber(e) ? e : e.limit, t), s = this.userDataReader.createContext(3, "limit");
		return r._readUserData(s), this._addStage(r);
	}
	distinct(e, ...t) {
		const n = __PRIVATE_isString(e) || __PRIVATE_isSelectable(e) ? {} : e, s = new __PRIVATE_Distinct(__PRIVATE_selectablesToMap(__PRIVATE_isString(e) || __PRIVATE_isSelectable(e) ? [e, ...t] : e.groups), n), i = this.userDataReader.createContext(3, "distinct");
		return s._readUserData(i), this._addStage(s);
	}
	aggregate(e, ...t) {
		...
		}(r), u = new __PRIVATE_Aggregate(__PRIVATE_selectablesToMap(s), o, n), _ = this.userDataReader.createContext(3, "aggregate");
	...
	*/ findNearest(e) {
		...
		}, s = new __PRIVATE_FindNearest(n, t, e.distanceMeasure, r), i = this.userDataReader.createContext(3, "addFields");
		return s._readUserData(i), this._addStage(s);
	}
	sort(e, ...t) {
		const n = __PRIVATE_isOrdering(e) ? {} : e, s = new __PRIVATE_Sort(__PRIVATE_isOrdering(e) ? [e, ...t] : e.orderings, n), i = this.userDataReader.createContext(3, "sort");
		return s._readUserData(i), this._addStage(s);
	}
	replaceWith(e) {
		const t = __PRIVATE_isString(e) || __PRIVATE_isExpr(e) ? {} : e, r = new __PRIVATE_Replace(__PRIVATE_fieldOrExpression(__PRIVATE_isString(e) || __PRIVATE_isExpr(e) ? e : e.map), t), s = this.userDataReader.createContext(3, "replaceWith");
		return r._readUserData(s), this._addStage(r);
	}
	sample(e) {
		const t = __PRIVATE_isNumber(e) ? {} : e;
		let n, r;
		__PRIVATE_isNumber(e) ? (n = e, r = "documents") : __PRIVATE_isNumber(e.documents) ? (n = e.documents, r = "documents") : (n = e.percentage, r = "percent");
		const s = new __PRIVATE_Sample(n, r, t), i = this.userDataReader.createContext(3, "sample");
		return s._readUserData(i), this._addStage(s);
	}
	union(e) {
		let t, n;
		...
		const r = new __PRIVATE_Union(n, t), s = this.userDataReader.createContext(3, "union");
		return r._readUserData(s), this._addStage(r);
	}
	unnest(e, t) {
		let n, r, s;
		...
		const u = new __PRIVATE_Unnest(i, a, n), _ = this.userDataReader.createContext(3, "unnest");
		return u._readUserData(_), this._addStage(u);
	}
	/**
	* @beta
	...
	* @returns A new {@link @firebase/firestore/pipelines#Pipeline} object with this stage appended to the stage list.
	*/ rawStage(e, n, r) {
		const i = new __PRIVATE_RawStage(e, n.map(((e) => e instanceof Expression || e instanceof AggregateFunction ? e : __PRIVATE_isPlainObject(e) ? function __PRIVATE__mapValue(e) {
			const t = /* @__PURE__ */ new Map();
		...
		}(e) : __PRIVATE__constant(e, "rawStage"))), r ?? {}), o = this.userDataReader.createContext(3, "rawStage");
		return i._readUserData(o), this._addStage(i);
	}
	/**
	* @internal
	* @private
	*/ _toProto(e) {
		return { stages: this.stages.map(((t) => t._toProto(e))) };
	}
	_addStage(e) {
...
function execute(e) {
	const t = __PRIVATE_getDatastore(e._db), n = new UserDataReader(e._db._databaseId, !0).createContext(3, "execute"), r = new __PRIVATE_StructuredPipelineOptions({}, {});
	r._readUserData(n);
	return __PRIVATE_invokeExecutePipeline(t, new StructuredPipeline(e, r)).then(((t) => {
		const n = t.length > 0 ? t[0].executionTime?.toTimestamp() : void 0;
		return new PipelineSnapshot(e, t.filter(((e) => !!e.fields)).map(((t) => new PipelineResult(e._userDataWriter, t.fields, t.key?.path ? new DocumentReference(e._db, null, t.key) : void 0, t.createTime?.toTimestamp(), t.updateTime?.toTimestamp()))), n);
	}));
}
/**
* @beta
...
//# sourceMappingURL=firebase_firestore_lite_pipelines.js.map