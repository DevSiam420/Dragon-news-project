import { C as LogLevel, D as FirebaseError, F as getUA, L as isCloudWorkstation, P as getModularInstance, U as isSafari, w as Logger } from "./index.esm-q5xya5K-.js";
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var zt = "WebChannelConnection", __PRIVATE_unguardedEventListen = (e, t, n) => {
	e.listen(t, ((e) => {
		try {
			n(e);
		} catch (e) {
	...
	*/ static u_() {
				...
				try {
					switch (_.getLastErrorCode()) {
						case ErrorCode.NO_ERROR:
							...
							__PRIVATE_logDebug(zt, `XHR for RPC '${e}' ${s} received:`, JSON.stringify(t)), i(t);
							break;
						...
						case ErrorCode.HTTP_ERROR:
							const n = _.getStatus();
							if (__PRIVATE_logDebug(zt, `RPC '${e}' ${s} failed with status:`, n, "response text:", _.getResponseText()), n > 0) {
	...
	T_(e, t, n) {
		...
		const h = new __PRIVATE_StreamBridge({
			Ho: (t) => {
				l ? __PRIVATE_logDebug(zt, `Not sending because RPC '${e}' stream ${r} is closed:`, t) : (c || (__PRIVATE_logDebug(zt, `Opening RPC '${e}' stream ${r} transport.`), u.open(), c = !0), __PRIVATE_logDebug(zt, `RPC '${e}' stream ${r} sending:`, t), u.send(t));
			},
			Jo: () => u.close()
		});
		return __PRIVATE_unguardedEventListen(u, WebChannel.EventType.OPEN, (() => {
			...
			l || (l = !0, __PRIVATE_logDebug(zt, `RPC '${e}' stream ${r} transport closed`), h.o_(), this.E_(u));
		})), __PRIVATE_unguardedEventListen(u, WebChannel.EventType.ERROR, ((t) => {
			l || (l = !0, __PRIVATE_logWarn(zt, `RPC '${e}' stream ${r} transport errored. Name:`, t.name, "Message:", t.message), h.o_(new FirestoreError(C.UNAVAILABLE, "The operation could not be completed")));
	...
	constructor(e, t, n, r, i) {
		this.localStore = e, this.datastore = t, this.asyncQueue = n, this.remoteSyncer = {}, this.Ta = [], this.Ia = /* @__PURE__ */ new Map(), this.Ea = /* @__PURE__ */ new Set(), this.Ra = [], this.Aa = i, this.Aa.Mo(((e) => {
			n.enqueueAndForget((async () => {
				__PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug(Ht, "Restarting streams for network reachability change."), await async function __PRIVATE_restartNetwork(e) {
					const t = __PRIVATE_debugCast(e);
...
*/ var OnlineComponentProvider = class {
	...
	async terminate() {
		await async function __PRIVATE_remoteStoreShutdown(e) {
			const t = __PRIVATE_debugCast(e);
			__PRIVATE_logDebug(Ht, "RemoteStore shutting down."), t.Ea.add(5), await __PRIVATE_disableNetworkInternal(t), t.Aa.shutdown(), t.Va.set("Unknown");
...
async function __PRIVATE_setOnlineComponentProvider(e, t) {
	...
	__PRIVATE_logDebug(Yt, "Initializing OnlineComponentProvider"), await t.initialize(n, e.configuration), e.setCredentialChangeListener(((e) => __PRIVATE_remoteStoreHandleCredentialChange(t.remoteStore, e))), e.setAppCheckTokenChangeListener(((e, n) => __PRIVATE_remoteStoreHandleCredentialChange(t.remoteStore, n))), e._onlineComponents = t;
}
/**
	...
	_getKnownOptions(e, t) {
		...
		for (const r in this.optionDefinitions) if (this.optionDefinitions.hasOwnProperty(r)) {
			...
			if (r in e) {
				const s = e[r];
				let o;
				if (i.nestedOptions && __PRIVATE_isPlainObject(s)) o = { mapValue: { fields: new OptionsUtil(i.nestedOptions).getOptionsProto(t, s) } };
...
*/ var __PRIVATE_StructuredPipelineOptions = class {
	constructor(e = {}, t = {}) {
		this.dc = e, this.mc = t, this.fc = new OptionsUtil({ indexMode: { serverName: "index_mode" } });
	}
	_readUserData(e) {
...
*/ function _internalPipelineToExecutePipelineRequestProto(e) {
	const n = function __PRIVATE_getDatastore(e) {
		if (e._terminated) throw new FirestoreError(C.FAILED_PRECONDITION, "The client has already been terminated.");
		if (!tn.has(e)) {
		...
		return tn.get(e);
	}(__PRIVATE_cast(e._db, Firestore)).serializer;
...
//#endregion
//#region node_modules/@firebase/firestore/dist/pipelines.esm.js
/**
* @license
* Copyright 2024 Google LLC
*
...
* limitations under the License.
*/
function __PRIVATE_isFirestoreValue(n) {
...
*/ function __PRIVATE_valueToDefaultExpr$1(n) {
	let t;
	return n instanceof Expression ? n : (t = __PRIVATE_isPlainObject(n) ? __PRIVATE__map(n) : n instanceof Array ? array(n) : __PRIVATE__constant(n, void 0), t);
}
/**
* Converts a value to an Expression, Returning either a Constant, MapFunction,
* ArrayFunction, or the input itself (if it's already an expression).
...
*/ var Expression = class {
	...
	*/ stringReplaceAll(e, n) {
		return new FunctionExpression("string_replace_all", [
			...
			__PRIVATE_valueToDefaultExpr$1(n)
		], "stringReplaceAll");
	}
	/**
	* @beta
	...
	*/ mapSet(e, n, ...t) {
		return new FunctionExpression("map_set", [
			...
			__PRIVATE_valueToDefaultExpr$1(e),
			__PRIVATE_valueToDefaultExpr$1(n),
			...t.map(__PRIVATE_valueToDefaultExpr$1)
		], "mapSet");
	}
	/**
	* @beta
	...
	*/ documentId() {
	...
	substring(e, n) {
		...
		return new FunctionExpression("substring", void 0 === n ? [this, t] : [
			this,
			t,
			__PRIVATE_valueToDefaultExpr$1(n)
		], "substring");
...
*/ var AggregateFunction = class AggregateFunction {
	...
	* @internal
	*/ _readUserData(e) {
		e = this._methodName ? e.contextWith({ methodName: this._methodName }) : e, this.params.forEach(((n) => n._readUserData(e)));
	}
};
/**
* @beta
...
*/ var AliasedExpression = class {
	constructor(e, n, t) {
		this.expr = e, this.alias = n, this._methodName = t, this.exprType = "AliasedExpression", this.selectable = !0;
	}
	/**
	* @private
	* @internal
...
*/ var __PRIVATE_ListOfExprs = class extends Expression {
	...
	* @internal
	*/ _toProto(e) {
		return { arrayValue: { values: this.t.map(((n) => n._toProto(e))) } };
	}
	/**
	* @private
	* @internal
...
*/ var Field = class extends Expression {
	...
	*/
	constructor(e, n) {
		super(), this.fieldPath = e, this._methodName = n, this.expressionType = "Field", this.selectable = !0;
	}
	get fieldName() {
...
*/ var MapValue = class extends Expression {
	...
	_readUserData(e) {
		e = this._methodName ? e.contextWith({ methodName: this._methodName }) : e, this.i.forEach(((n) => {
			n._readUserData(e);
		}));
	}
	_toProto(e) {
...
function __PRIVATE_toPipelineBooleanExpr(e) {
	if (e instanceof FieldFilter) {
		...
		switch (e.op) {
			case "<": return and(n.exists(), n.lessThan(Constant._fromProto(t)));
			case "<=": return and(n.exists(), n.lessThanOrEqual(Constant._fromProto(t)));
			case ">": return and(n.exists(), n.greaterThan(Constant._fromProto(t)));
			case ">=": return and(n.exists(), n.greaterThanOrEqual(Constant._fromProto(t)));
			case "==": return and(n.exists(), n.equal(Constant._fromProto(t)));
			case "!=": return n.notEqual(Constant._fromProto(t));
			case "array-contains": return and(n.exists(), n.arrayContains(Constant._fromProto(t)));
			case "in": {
...
function __PRIVATE_toPipeline(e, n) {
	...
	if (i.length > 0) if ("L" === e.limitType) {
		...
		t = t.sort(n[0], ...n.slice(1)), null !== e.startAt && (t = t.where(__PRIVATE_whereConditionsFromCursor(e.startAt, i, "after"))), null !== e.endAt && (t = t.where(__PRIVATE_whereConditionsFromCursor(e.endAt, i, "before"))), t = t.limit(e.limit), t = t.sort(i[0], ...i.slice(1));
...
function __PRIVATE_whereConditionsFromCursor(e, n, t) {
	...
	for (let e = i - 2; e >= 0; e--) o = n[e].expr, a = s[e], u = or(r(o, a), and(o.equal(a), u));
	return u;
}
/**
* @license
...
*/ var __PRIVATE_CollectionSource = class extends Stage {
	...
	constructor(e, n) {
		super(n), this.o = e.startsWith("/") ? e : "/" + e;
	}
	/**
	* @internal
	* @private
...
*/ var __PRIVATE_DocumentsSource = class extends Stage {
	...
	*/ _toProto(e) {
		return {
			...super._toProto(e),
			args: this.u.map(((e) => ({ referenceValue: e })))
		};
	}
	_readUserData(e) {
		super._readUserData(e);
...
*/ var __PRIVATE_Limit = class extends Stage {
	...
	constructor(e, n) {
		__PRIVATE_hardAssert(!isNaN(e) && e !== Infinity && e !== -Infinity, 34860), super(n), this.limit = e;
	}
	/**
	* @internal
	* @private
...
var __PRIVATE_RawStage = class extends Stage {
	...
	*/
	constructor(e, n, t) {
		super({ rawOptions: t }), this.name = e, this.params = n;
	}
	/**
	* @internal
	* @private
...
*/ function __PRIVATE_readUserDataHelper(e, n) {
	return __PRIVATE_isUserData(e) ? e._readUserData(n) : Array.isArray(e) ? e.forEach(((e) => e._readUserData(n))) : e.forEach(((e) => e._readUserData(n))), e;
}
/**
* @license
* Copyright 2024 Google LLC
...
*/ var PipelineSource = class {
	...
	*/
	...
	collection(e) {
		...
		const i = new __PRIVATE_CollectionSource(__PRIVATE_isString(r) ? r : r.path, n), o = this.userDataReader.createContext(3, "collection");
		return i._readUserData(o), this._createPipeline([i]);
	}
	collectionGroup(e) {
		let n, r;
		__PRIVATE_isString(e) ? (n = e, r = {}) : {collectionId: n, ...r} = e;
		const s = new __PRIVATE_CollectionGroupSource(n, r), i = this.userDataReader.createContext(3, "collectionGroup");
		return s._readUserData(i), this._createPipeline([s]);
	}
	database(e) {
		const n = new __PRIVATE_DatabaseSource(e = e ?? {}), t = this.userDataReader.createContext(3, "database");
		return n._readUserData(t), this._createPipeline([n]);
	}
	documents(e) {
		let n, r;
		Array.isArray(e) ? (r = e, n = {}) : {docs: r, ...n} = e, r.filter(((e) => e instanceof DocumentReference)).forEach(((e) => this._validateReference(e)));
		const i = new __PRIVATE_DocumentsSource(r.map(((e) => __PRIVATE_isString(e) ? e : e.path)), n), o = this.userDataReader.createContext(3, "documents");
		return i._readUserData(o), this._createPipeline([i]);
	}
	/**
	* @beta
...
*/ function __PRIVATE_selectablesToMap(e) {
	...
	for (const r of e) {
		let e, s;
		if ("string" == typeof r ? (e = r, s = field(r)) : r instanceof Field || r instanceof AliasedExpression ? (e = r.alias, s = r.expr) : fail(21273, { selectable: r }), void 0 !== t.get(e)) throw new FirestoreError("invalid-argument", `Duplicate alias or field '${e}'`);
		t.set(e, s);
	}
	return t;
}
...
function __PRIVATE_fieldOrExpression(n) {
	if (__PRIVATE_isString(n)) return field(n);
	/**
	* Converts a value to an Expression, Returning either a Constant, MapFunction,
	* ArrayFunction, or the input itself (if it's already an expression).
	*
...
var Pipeline$1 = class Pipeline$1 {
	/**
	* @internal
	* @private
	* @param _db
	...
	*/
	...
	addFields(e, ...n) {
		...
		const i = new __PRIVATE_AddFields(__PRIVATE_selectablesToMap(t), r), o = this.userDataReader.createContext(3, "addFields");
		return i._readUserData(o), this._addStage(i);
	}
	removeFields(e, ...n) {
		const r = __PRIVATE_isField(e) || __PRIVATE_isString(e) ? {} : e, i = new __PRIVATE_RemoveFields((__PRIVATE_isField(e) || __PRIVATE_isString(e) ? [e, ...n] : e.fields).map(((e) => __PRIVATE_isString(e) ? field(e) : e)), r);
		return i._readUserData(this.userDataReader.createContext(3, "removeFields")), this._addStage(i);
	}
	select(e, ...n) {
		const r = __PRIVATE_isSelectable(e) || __PRIVATE_isString(e) ? {} : e, i = new __PRIVATE_Select(__PRIVATE_selectablesToMap(__PRIVATE_isSelectable(e) || __PRIVATE_isString(e) ? [e, ...n] : e.selections), r), o = this.userDataReader.createContext(3, "select");
		return i._readUserData(o), this._addStage(i);
	}
	where(e) {
		const n = __PRIVATE_isBooleanExpr(e) ? {} : e, r = new __PRIVATE_Where(__PRIVATE_isBooleanExpr(e) ? e : e.condition, n), s = this.userDataReader.createContext(3, "where");
		return r._readUserData(s), this._addStage(r);
	}
	offset(e) {
		let n, t;
		__PRIVATE_isNumber$1(e) ? (n = {}, t = e) : (n = e, t = e.offset);
		const r = new __PRIVATE_Offset(t, n), s = this.userDataReader.createContext(3, "offset");
		return r._readUserData(s), this._addStage(r);
	}
	limit(e) {
		const n = __PRIVATE_isNumber$1(e) ? {} : e, r = new __PRIVATE_Limit(__PRIVATE_isNumber$1(e) ? e : e.limit, n), s = this.userDataReader.createContext(3, "limit");
		return r._readUserData(s), this._addStage(r);
	}
	distinct(e, ...n) {
		const r = __PRIVATE_isString(e) || __PRIVATE_isSelectable(e) ? {} : e, i = new __PRIVATE_Distinct(__PRIVATE_selectablesToMap(__PRIVATE_isString(e) || __PRIVATE_isSelectable(e) ? [e, ...n] : e.groups), r), o = this.userDataReader.createContext(3, "distinct");
		return i._readUserData(o), this._addStage(i);
	}
	aggregate(e, ...t) {
		...
		}(s), u = new __PRIVATE_Aggregate(__PRIVATE_selectablesToMap(i), o, r), _ = this.userDataReader.createContext(3, "aggregate");
	...
	*/ findNearest(e) {
		...
		}, s = new __PRIVATE_FindNearest(t, n, e.distanceMeasure, r), i = this.userDataReader.createContext(3, "addFields");
		return s._readUserData(i), this._addStage(s);
	}
	sort(e, ...n) {
		const t = __PRIVATE_isOrdering(e) ? {} : e, s = new __PRIVATE_Sort(__PRIVATE_isOrdering(e) ? [e, ...n] : e.orderings, t), i = this.userDataReader.createContext(3, "sort");
		return s._readUserData(i), this._addStage(s);
	}
	replaceWith(e) {
		const n = __PRIVATE_isString(e) || __PRIVATE_isExpr(e) ? {} : e, s = new __PRIVATE_Replace(__PRIVATE_fieldOrExpression(__PRIVATE_isString(e) || __PRIVATE_isExpr(e) ? e : e.map), n), i = this.userDataReader.createContext(3, "replaceWith");
		return s._readUserData(i), this._addStage(s);
	}
	sample(e) {
		...
		const s = new __PRIVATE_Sample(t, r, n), i = this.userDataReader.createContext(3, "sample");
		return s._readUserData(i), this._addStage(s);
	}
	union(e) {
		let n, t;
		...
		const r = new __PRIVATE_Union(t, n), s = this.userDataReader.createContext(3, "union");
		return r._readUserData(s), this._addStage(r);
	}
	unnest(e, n) {
		let r, s, i;
		...
		const u = new __PRIVATE_Unnest(o, a, r), _ = this.userDataReader.createContext(3, "unnest");
		return u._readUserData(_), this._addStage(u);
	}
	/**
	* @beta
	...
	* @returns A new {@link @firebase/firestore/pipelines#Pipeline} object with this stage appended to the stage list.
	*/ rawStage(n, t, r) {
		const i = new __PRIVATE_RawStage(n, t.map(((n) => n instanceof Expression || n instanceof AggregateFunction ? n : __PRIVATE_isPlainObject(n) ? function __PRIVATE__mapValue(e) {
		...
		}(n) : __PRIVATE__constant(n, "rawStage"))), r ?? {}), o = this.userDataReader.createContext(3, "rawStage");
		return i._readUserData(o), this._addStage(i);
	}
	/**
	* @internal
	* @private
	*/ _toProto(e) {
		return { stages: this.stages.map(((n) => n._toProto(e))) };
	}
	_addStage(e) {
...
var Pipeline = class Pipeline extends Pipeline$1 {
	/**
	* @internal
	* @private
	* @param db
...
* limitations under the License.
*/ function execute(e) {
	const { pipeline: t, rawOptions: r, ...s } = e instanceof Pipeline$1 ? { pipeline: e } : e, i = __PRIVATE_cast(t._db, Firestore), o = ensureFirestoreConfigured(i), a = new UserDataReader(i._databaseId, !0).createContext(3, "execute"), u = new __PRIVATE_StructuredPipelineOptions(s, r);
	u._readUserData(a);
	return __PRIVATE_firestoreClientExecutePipeline(o, new StructuredPipeline(t, u)).then(((e) => {
		const n = e.length > 0 ? e[0].executionTime?.toTimestamp() : void 0;
		return new PipelineSnapshot(t, e.filter(((e) => !!e.fields)).map(((e) => new PipelineResult(t._userDataWriter, e.fields, e.key?.path ? new DocumentReference(i, null, e.key) : void 0, e.createTime?.toTimestamp(), e.updateTime?.toTimestamp()))), n);
	}));
}
/**
* @beta
